...
# ─── D+ DE RESGATE (dias úteis) ───────────────────────────────────────────────
# Confirmar com cada gestora — valores estimados abaixo
LIQUIDEZ_DIAS = {
    "BTG PACTUAL DIGITAL TESOURO SELIC FIF RENDA FIXA SIMPLES":    0,
    "CAPITÂNIA REIT MASTER RESP LIMITADA FIF CIC MULTIMERCADO":    30,
    "GAMA PEARL DIVER GLOBAL FLOATING INCOME BRL INVESTIMENTO NO EXTERIOR RESP LIMITADA FIF CIC": 30,
    "GAMA SCHRODER GAIA CONTOUR TECH EQUITY LONG & SHORT BRL INVESTIMENTO NO EXTERIOR RESP LIMITADA FIF CIC MULTIMERCADO": 30,
    "ITAÚ DEBÊNTURES INCENTIVADAS CDI DIST RESP LIMITADA FIF CIC FI INFRA RENDA FIXA CRÉDITO PRIVADO": 30,
    "M MACRO FIF CIC MULTIMERCADO":               30,
    "MCA II RESP LIMITADA FICFIDC 1":              60,
    "MHX FICFIDC 1":                               60,
    "MORE CRÉDITO RESP LIMITADA FICFIDC 1":        60,
    "NEST IBOVESPA ENHANCED RESP LIMITADA FIF AÇÕES": 30,
    "SPARTA DEBÊNTURES INCENTIVADAS INFLAÇÃO RESP LIMITADA FIF CIC FI INFRA RENDA FIXA": 30,
    "M BRZ RESP LIMITADA FICFIDC 1":              60,
    "M8 CREDIT OPPORTUNITIES FICFIDC 1":          60,
}


# ─── LIQUIDEZ (D+ de resgate) ────────────────────────────────────────────────
# ⚠ ESTIMATIVAS — confirmar com as gestoras antes de usar em produção
LIQUIDEZ_DIAS = {
    "BTG PACTUAL DIGITAL TESOURO SELIC FIF RENDA FIXA SIMPLES": 0,
    "CAPITÂNIA REIT MASTER RESP LIMITADA FIF CIC MULTIMERCADO": 30,
    "GAMA PEARL DIVER GLOBAL FLOATING INCOME BRL INVESTIMENTO NO EXTERIOR RESP LIMITADA FIF CIC": 30,
